                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.register')" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="profile-picture" class="col-md-4 col-form-label text-md-right">@lang('Profile Picture')</label>

                                <div class="col-md-6">
                                    <input type="file" name="profile_picture" id="profile-picture" class="form-control" placeholder="{{ __('Profile Picture') }}" required />
                                </div>
                            </div><!--form-group-->
